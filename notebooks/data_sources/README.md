...
3. `Administrative boundaries` have been retrieved from Dublin city council ([electoral Divisions geometries](https://data.gov.ie/dataset/electoral-divisions-dcc), downloaded Apr 9, 2025) and from Hamburg data portal ([Stadtteile data source](https://metaver.de/trefferanzeige?docuuid=F4062BD8-43C4-4C4F-AA45-253D84A3685E), downloaded July, 2025). Dublin has 162 electoral divisions, while Hamburg has 104 Stadtteile, of which one is completely outside area of interest (disconnected, an island), and 4 are coupled in the proposed data source, for a total of 99 units under analysis.
